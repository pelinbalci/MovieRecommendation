...
def show_train_predict_page():
    ...
    all_genres_df = utils.prepare_selected_movies(df_movie, df_ratings_mean_temp)
    ...
    if comedy_b:
        for i in range(3):
            ...
            # remove movie not ot show the same movie to user.
            all_genres_df = all_genres_df[(all_genres_df.movieId != movie_idx)]
